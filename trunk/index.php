...
if($page->getVar('up_pageid') !=0 ) {
	$xoopsTpl->assign('mail_cmd', 'mailto:?subject='.sprintf(_USERPAGE_INTARTICLE,$xoopsConfig['sitename']).'&amp;body='.sprintf(_USERPAGE_INTARTFOUND, $xoopsConfig['sitename']).':  '.ICMS_URL.'/modules/userpage/index.php?page_id='.$page->getVar('up_pageid'));
