...
if(!is_object($xoopsUser)) {	// Only for registred users
	redirect_header(ICMS_URL.'/index.php', 2, _ERRORS);
	exit();
}
*/
...
if($cnt>0) {
	...
	redirect_header(ICMS_URL.'/index.php', 2, _USERPAGE_PAGE_NOT_FOUND);
	exit();
}
...
echo '<body bgcolor="#ffffff" text="#000000" onload="window.print()">
	...
	<img src="'.ICMS_URL.'/images/logo.gif" border="0" alt="" /><br /><br />
...
echo '<br /><a href="'.ICMS_URL.'/">'.ICMS_URL.'</a><br /><br />'._USERPAGE_URLFORPAGE.' <br /><a href="'.$page->getURL().'">'.$page->getURL().'</a></td></tr></table></body></html>';
?>