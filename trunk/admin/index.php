...
require_once ICMS_ROOT_PATH.'/modules/userpage/include/common.php';
require_once ICMS_ROOT_PATH.'/modules/userpage/admin/functions.php';
...
switch ($op) {
	...
	default:
		...
		if (file_exists(ICMS_ROOT_PATH.'/language/'.$xoopsConfig['language'].'/admin.php')) {
			require_once ICMS_ROOT_PATH.'/language/'.$xoopsConfig['language'].'/admin.php';
		} else {
			require_once ICMS_ROOT_PATH.'/modules/userpage/language/english/main.php';
		}

		if (file_exists(ICMS_ROOT_PATH.'/modules/userpage/language/'.$xoopsConfig['language'].'/main.php')) {
			require_once ICMS_ROOT_PATH.'/modules/userpage/language/'.$xoopsConfig['language'].'/main.php';
		} else {
			require_once ICMS_ROOT_PATH.'/modules/userpage/language/english/main.php';
		}
		...
		foreach($pages as $page) {
			...
			echo "<td><a href=\"".ICMS_URL."/modules/userpage/index.php?page_id=".$page->getVar('up_pageid')."\">".$page->getVar('up_title')."</a></td>";
